    ...
    <Tab.Navigator>
      {isLoggedIn ? (
        <>
          ...
          <Tab.Screen name='HelEvent' component={HelEvent} options={{ tabBarIcon:({color, size}) => (<Icon name="event"></Icon>)}} />
        </>
      ) : (
        <>
          <Tab.Screen  name='Home' component={Home}  options={{ tabBarIcon:({color, size}) => (<Icon name="home"></Icon>)}}/>
